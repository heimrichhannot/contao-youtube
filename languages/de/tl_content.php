...
$GLOBALS['TL_LANG']['tl_content']['videoDuration'] = array('Länge', 'Geben Sie hier die Dauer des YouTube-Videos ein.');
...
$GLOBALS['TL_LANG']['tl_content']['youtubeFullsize'] = array('Großansicht/Neues Fenster', 'Großansicht des Videos in einer Lightbox bzw. den Link in einem neuem Browserfenster öffnen.');
$GLOBALS['TL_LANG']['tl_content']['youtubeLinkText'] = array('Link-Text', 'Der angezeigte Text des Links, der die Lightbox öffnet.');